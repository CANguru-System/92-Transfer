...
#define EFUSE_RD_CHIP_VER_RESERVE_S 1100
#define EFUSE_RD_CHIP_VER_RESERVE_V 111
...
// TWAI is the name that Esperssif uses for the CAN peripheral. It stands for *two wire automotive interface*
